...
class TypedQuery<
  ...
  Future<TypedQuerySnapshot<D, U, DR, DC>> getDocuments() => _query.get().then(
  ...
  DC reference() => _toTypedCollectionReference(_query);
  ...
  TypedQuery<D, U, DR, DC> startAfterDocument(
    TypedDocumentSnapshot<D, U, DR, DC> documentSnapshot,
      ...
      TypedQuery._fromQuery(
        _query.startAfter(snapshot: documentSnapshot._snapshot),
        _toTypedDocumentReference,
        _toTypedCollectionReference,
      );
  ...
  TypedQuery<D, U, DR, DC> startAtDocument(
    TypedDocumentSnapshot<D, U, DR, DC> documentSnapshot,
      ...
      TypedQuery._fromQuery(
        _query.startAt(snapshot: documentSnapshot._snapshot),
        _toTypedDocumentReference,
        _toTypedCollectionReference,
      );
  ...
  TypedQuery<D, U, DR, DC> startAfter(List<dynamic> values) =>
      TypedQuery._fromQuery(
        _query.startAfter(values: values),
        _toTypedDocumentReference,
        _toTypedCollectionReference,
      );
  ...
  TypedQuery<D, U, DR, DC> endAtDocument(
    TypedDocumentSnapshot<D, U, DR, DC> documentSnapshot,
      ...
      TypedQuery._fromQuery(
        _query.endAt(snapshot: documentSnapshot._snapshot),
        _toTypedDocumentReference,
        _toTypedCollectionReference,
      );
  ...
  TypedQuery<D, U, DR, DC> endBeforeDocument(
    TypedDocumentSnapshot<D, U, DR, DC> documentSnapshot,
      ...
      TypedQuery._fromQuery(
        _query.endBefore(snapshot: documentSnapshot._snapshot),
        _toTypedDocumentReference,
        _toTypedCollectionReference,
      );
  ...
  TypedQuery<D, U, DR, DC> endBefore(List<dynamic> values) =>
      TypedQuery._fromQuery(
        _query.endBefore(values: values),
        _toTypedDocumentReference,
        _toTypedCollectionReference,
      );
