...
import 'package:meta_types/meta_types_models.dart'
    show Data, DataField, MetaInterfaceType;

Field genDataField(Data<DataField> d) => Field((b) => b
  ..name = '_meta\$'
  ..type = Reference('Data<DataValue>'));

Method genDataGetter(Data<DataField> d) => Method(
      (b) => b
        ..name = 'meta\$'
...
String _interfacesReturnValue(MetaInterfaceType<Data<DataField>> m) =>
