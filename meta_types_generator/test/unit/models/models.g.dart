...
class DataClassMixinBase extends $DataClassMixinBase {
  DataClassMixinBase({int implementor})
      : _implementor = implementor,
        assert(implementor != null);

  final int _implementor;

  DataClassMixinBase clone({int implementor}) {
    return DataClassMixinBase(
      implementor: implementor ?? _implementor,
    );
  }
  ...
  String toString() {
    return "DataClassMixinBase (implementor: $implementor)";
  }
}
...
class SealedClassMixinBase extends $SealedClassMixinBase {
  SealedClassMixinBase.a(int a)
      : assert(a != null),
        _a = a,
        _b = null;

  SealedClassMixinBase.b(int b)
      : _a = null,
        assert(b != null),
        _b = b;

  SealedClassMixinBase({int a, int b})
      : _a = a,
        _b = b {
    var found = false;
    if (a != null) {
  ...
  void whenB(void Function(int) handler) {
    if (_b != null) handler(_b);
  }

  WHEN when<WHEN>({WHEN Function(int) a, WHEN Function(int) b}) {
    if (_a != null) {
      return a(_a);
    }
    if (_b != null) {
  ...
  WHENO wheno<WHENO>(
      {WHENO Function() otherwise,
      WHENO Function(int) a,
      WHENO Function(int) b}) {
    if (_a != null) {
      return a(_a);
    }
    if (_b != null) {
  ...
  String toString() {
    ...
    return 'SealedClassMixinBase( $value )';
  }
}

abstract class ISealedClassMixinBase extends SealedClass {
  Option<int> get aOption;
  Option<int> get bOption;
  void whenA(void Function(int) handler);
  void whenB(void Function(int) handler);
  WHEN when<WHEN>({WHEN Function(int) a, WHEN Function(int) b});
  WHENO wheno<WHENO>(
...
abstract class ITestSealedClass extends SealedClass {
...
abstract class IGeneric1SealedClass<T> extends SealedClass {
...
abstract class IGenericSealedClass<T1, T2> extends SealedClass {
...
abstract class INestingSealedClass extends SealedClass {
  Option<int> get integerOption;
...
abstract class INestedSealedClass extends SealedClass {
  Option<int> get integerOption;
  Option<String> get stringOption;
  void whenInteger(void Function(int) handler);
  void whenString(void Function(String) handler);
